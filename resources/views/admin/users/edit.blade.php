...
<div class="page-content">
    <div class="panel">
        ...
        <form method="POST" id="hms_form" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group form-material {{ $errors->has('mobile_no') ? 'has-danger' : '' }}">
                        ...
                        <input class="form-control" type="text" name="mobile_no" id="mobile_no" value="{{ old('mobile_no',$user->mobile_no) }}" >
                        <div class="invalid-feedback">
