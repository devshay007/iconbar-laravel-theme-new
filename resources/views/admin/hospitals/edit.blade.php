...
<div class="page-content">
    <div class="panel">
        ...
        <form method="POST" id="hms_form" action="{{ route("admin.hospitals.update", [$hospital->hospid]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group form-material {{ $errors->has('hospcode') ? 'has-danger' : '' }}">
                        ...
                        <input class="form-control" type="text" name="hospcode" id="hospcode" maxlength="5" value="{{ old('hospcode',$hospital->hospcode) }}">
                ...
                <div class="col-md-6">
                    <div class="form-group form-material {{ $errors->has('hospname') ? 'has-danger' : '' }}">
                        ...
                        <input class="form-control" type="text" name="hospname" id="hospname" maxlength="100" value="{{ old('hospname',$hospital->hospname) }}" >
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                     <div class="form-group form-material {{ $errors->has('hospaddr1') ? 'has-danger' : '' }}">
                        ...
                        <textarea class="form-control" id="hospaddr1" name="hospaddr1" rows="3" maxlength="100">{{ old('hospaddr1',$hospital->hospaddr1) }}</textarea>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="form-group form-material {{ $errors->has('hospaddr2') ? 'has-danger' : '' }}">
                        ...
                        <textarea class="form-control" id="hospaddr2" name="hospaddr2" rows="3" maxlength="100">{{ old('hospaddr2',$hospital->hospaddr2) }}</textarea>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="form-group form-material {{ $errors->has('hospaddr3') ? 'has-danger' : '' }}">
                        ...
                        <textarea class="form-control" id="hospaddr3" name="hospaddr3" rows="3" maxlength="100">{{ old('hospaddr3',$hospital->hospaddr3) }}</textarea>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">    
                    <div class="form-group form-material {{ $errors->has('hospzip') ? 'has-danger' : '' }}">
                        ...
                        <input class="form-control" type="number" name="hospzip" id="hospzip" value="{{ old('hospzip',$hospital->hospzip) }}" maxlength="8" >
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="form-group form-material {{ $errors->has('hospcity') ? 'has-danger' : '' }}">
                        ...
                        <input class="form-control" type="text" name="hospcity" id="hospcity" maxlength="50" value="{{ old('hospcity',$hospital->hospcity) }}" >
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="form-group form-material {{ $errors->has('hospstate') ? 'has-danger' : '' }}">
                        ...
                        <input class="form-control" type="text" name="hospstate" id="hospstate" maxlength="50" value="{{ old('hospstate',$hospital->hospstate) }}" maxlength="50">
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="form-group form-material {{ $errors->has('hospcontry') ? 'has-danger' : '' }}">
                        ...
                        <input class="form-control" type="text" name="hospcontry" id="hospcontry" maxlength="50" value="{{ old('hospcontry',$hospital->hospcontry) }}" maxlength="50" >
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="form-group form-material {{ $errors->has('hospemail') ? 'has-danger' : '' }}">
                        ...
                        <input class="form-control" type="email" name="hospemail" id="hospemail" maxlength="100" value="{{ old('hospemail',$hospital->hospemail) }}" >
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="form-group form-material {{ $errors->has('hospweb') ? 'has-danger' : '' }}">
                        ...
                        <input class="form-control" type="url" name="hospweb" id="hospweb" maxlength="100" value="{{ old('hospweb',$hospital->hospweb) }}" >
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">    
                    <div class="form-group form-material {{ $errors->has('hospphone') ? 'has-danger' : '' }}">
                        ...
                        <input class="form-control" type="number" name="hospphone" id="hospphone" minlength="10" value="{{ old('hospphone',$hospital->hospphone) }}">
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">    
                    <div class="form-group form-material {{ $errors->has('hospmobile1') ? 'has-danger' : '' }}">
                        ...
                        <input class="form-control" type="number" name="hospmobile1" id="hospmobile1" minlength="10" value="{{ old('hospmobile1',$hospital->hospmobile1) }}">
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">    
                    <div class="form-group form-material {{ $errors->has('hospmobile2') ? 'has-danger' : '' }}">
                        ...
                        <input class="form-control" type="number" name="hospmobile2" id="hospmobile2" minlength="10" value="{{ old('hospmobile2',$hospital->hospmobile2) }}">
                        <div class="invalid-feedback">
