...
<div class="page-header">
    <h1 class="page-title">{{ trans('global.create') }} {{ trans('cruds.permission.title_singular') }}</h1>
</div>

<div class="page-content">
    <div class="panel">
        <div class="panel-body">
            <form method="POST" action="{{ route("admin.permissions.store") }}" enctype="multipart/form-data" id="hms_form">
                @csrf
