...
<div class="page-header">
    <h1 class="page-title">{{ trans('global.edit') }} {{ trans('cruds.role.title_singular') }}</h1>
</div>
<div class="page-content">
    <div class="panel">
        <div class="panel-body">
            <form method="POST" id="hms_form" action="{{ route("admin.roles.update", [$role->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
